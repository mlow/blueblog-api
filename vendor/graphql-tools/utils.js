import { parse, isObjectType, isScalarType, isSpecifiedScalarType, isIntrospectionType, print, printType, specifiedRules, Kind, validate, buildSchema, buildClientSchema, Source, isListType, isNonNullType, getNamedType, isEnumType, GraphQLString, GraphQLNonNull, GraphQLList, isInterfaceType, isInputObjectType, GraphQLID, GraphQLBoolean, GraphQLFloat, GraphQLInt, isSpecifiedDirective, GraphQLDirective, GraphQLObjectType, GraphQLInterfaceType, isUnionType, GraphQLUnionType, GraphQLInputObjectType, GraphQLEnumType, GraphQLScalarType, isNamedType, getNullableType, isLeafType, GraphQLSchema, isDirective, getDirectiveValues as getDirectiveValues$1, GraphQLSkipDirective, GraphQLIncludeDirective, typeFromAST, isAbstractType, isCompositeType, doTypesOverlap, GraphQLError, valueFromAST, isSchema, isInputType, valueFromASTUntyped } from '../graphql.js';
...
function debugLog(...args) {
  if (process && process.env && {}.DEBUG && !{}.GQL_tools_NODEBUG) {
